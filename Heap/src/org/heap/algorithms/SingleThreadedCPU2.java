...
// All 39 test cases are passed
public class SingleThreadedCPU2 {
...
//	        pq.offer(new Pair(third_arr[0][1], third_arr[0][2]));
		...
		while (j < n || !pq.isEmpty()) {
			...
			if(pq.isEmpty() && currTime < third_arr[j][0]) {
				currTime = third_arr[j][0];
			}
	...
	public static void main(String[] args) {
		...
		SingleThreadedCPU2 obj = new SingleThreadedCPU2();
